...
Elm.Color.make = function (_elm) {
   ...
   _elm.Color.values = {_op: _op
                       ...
                       ,Radial: Radial};
   return _elm.Color.values;
};Elm.Session = Elm.Session || {};
Elm.Session.make = function (_elm) {
   "use strict";
   _elm.Session = _elm.Session || {};
   if (_elm.Session.values)
   return _elm.Session.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "Session";
   var Native = Native || {};
   Native.Session = Elm.Native.Session.make(_elm);
   var Signal = Elm.Signal.make(_elm);
   var _op = {};
   var destroySession = Native.Session.destroySession;
   var update = Native.Session.update;
   var sessionVar = Native.Session.sessionVar;
   var SessionVar = F2(function (a,
   b) {
      return {_: {}
             ,handle: a
             ,signal: b};
...
Elm.Random.make = function (_elm) {
   ...
   _elm.Random.values = {_op: _op
                        ...
                        ,floatList: floatList};
   return _elm.Random.values;
};Elm.DataSource = Elm.DataSource || {};
Elm.DataSource.make = function (_elm) {
   "use strict";
   _elm.DataSource = _elm.DataSource || {};
   if (_elm.DataSource.values)
   return _elm.DataSource.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _E = _N.Error.make(_elm),
   ...
   var Native = Native || {};
   Native.DataSource = Elm.Native.DataSource.make(_elm);
   var Signal = Elm.Signal.make(_elm);
   var _op = {};
   var mutate = Native.DataSource.mutate;
   var query = F2(function (h,q) {
      return A2(Native.DataSource.query,
      h,
      JavaScript.Experimental.fromRecord(q));
   });
   var dataSource = Native.DataSource.dataSource;
   var DataSource = F2(function (a,
   b) {
      return {_: {}
             ,handle: a
             ,signal: b};
   ...
   var Doc = F2(function (a,b) {
      return {_: {},body: b,id: a};
   });
   _elm.DataSource.values = {_op: _op
                            ,dataSource: dataSource
                            ,query: query
                            ,mutate: mutate
                            ,Delete: Delete
