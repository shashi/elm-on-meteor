...
Elm.Array.make = function (_elm) {
   ...
   var getUnsafe = Native.Array.get;
      ...
      return function () {
         ...
         {case "RBEmpty":
            ...
            return function () {
                 ...
                 switch (_v33.ctor)
                 {case "EQ": return t._2;
                    case "GT": return A3(getSafe,
                      base,
                      k,
                      t._4);
                    case "LT": return A3(getSafe,
                      base,
                      k,
                      t._3);}
                 _E.Case($moduleName,
   ...
   t) {
      return function () {
         ...
         {case "RBEmpty":
            switch (t._0.ctor)
              {case "LBlack":
                 return Native.Error.raise("key not found when using \'getUnsafe\'");}
              break;
            case "RBNode":
            return function () {
                 ...
                 switch (_v41.ctor)
                 {case "EQ": return t._2;
                    case "GT": return A2(getUnsafe,
                      k,
                      t._4);
                    case "LT": return A2(getUnsafe,
                      k,
                      t._3);}
                 _E.Case($moduleName,
