...
Elm.Database.make = function (_elm)
                    {
                      _elm.Database = _elm.Database || {};
                      if (_elm.Database.values)
                      return _elm.Database.values;
                      var N = Elm.Native,
                          _N = N.Utils.make(_elm),
                          _L = N.List.make(_elm),
                          _E = N.Error.make(_elm),
                      ...
                      var Native = Native || {};
                      Native.Database = Elm.Native.Database.make(_elm);
                      var _op = {};
                      var select = F2(function (c,q)
                                      {
                                        return A2(Native.Database.select,
                                                  c,
                                                  JavaScript.Experimental.fromRecord(q));
                                      });
                      var mutate = Native.Database.mutate;
                      var collection = Native.Database.collection;
                      var Waiting = {ctor: "Waiting"};
                      ...
                      _elm.Database.values = {_op: _op, collection: collection, select: select, mutate: mutate, Delete: Delete, Update: Update, Create: Create, Success: Success, Waiting: Waiting, Failure: Failure, Doc: Doc, Query: Query};
                      return _elm.Database.values;
